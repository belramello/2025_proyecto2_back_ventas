...
export class HistorialActividadesController {
  constructor(private readonly historialActividadesService: HistorialActividadesService) {}

  @Post()
  create(@Body() createHistorialActividadeDto: CreateHistorialActividadesDto) {
    return this.historialActividadesService.create(createHistorialActividadeDto);
  }
